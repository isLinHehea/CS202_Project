...
#
# Generated by export_simulation on Fri May 12 16:46:30 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './programROM.sh' script.

./programROM.sh -reset_run
...
./programROM.sh -noclean_files

For more information on the script, please type './programROM.sh -help'.
